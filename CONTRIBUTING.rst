...
Welcome to ``susiepca`` contributor's guide.
...
If you experience bugs or general issues with ``susiepca``, please have a look
...
You can help improve ``susiepca`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``susiepca`` documentation uses Sphinx_ as its main documentation compiler.
This means that the docs are kept in the same repository as the project code, and
that any documentation update is done in the same way was a code contribution.
``susiepca`` uses reStructuredText_ as its principle markup language.

.. tip::
   Please notice that the `GitHub web interface`_ provides a quick way of
   propose changes in ``susiepca``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n susiepca python=3 six virtualenv pytest pytest-cov
    conda activate susiepca
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/susiepca.git
    cd susiepca
...
#. Install |pre-commit|_::
   ...
   ``susiepca`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/mancusolab/susiepca
.. _issue tracker: https://github.com/mancusolab/susiepca/issues
.. <-- end -->
